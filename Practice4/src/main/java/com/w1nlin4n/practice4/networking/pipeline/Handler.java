...
import com.w1nlin4n.practice4.controllers.Controller;
import com.w1nlin4n.practice4.controllers.Endpoint;
...
public class Handler {
    ...
    public Handler(ProductsDB productsDB) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Reflections reflections = new Reflections("com.w1nlin4n.practice4");
